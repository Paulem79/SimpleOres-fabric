...
stonecutter parameters {
    ...
    swaps["armorMaterialType"] = when {
        eval(current.version, "1.20.6") || eval(current.version, "1.21") -> "Holder<ArmorMaterial>"
        eval(current.version, ">1.20.4") -> "ArmorMaterial"
        else -> "ModArmorMaterials"
    }

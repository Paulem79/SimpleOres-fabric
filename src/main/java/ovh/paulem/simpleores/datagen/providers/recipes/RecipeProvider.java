...
public class RecipeProvider extends FabricRecipeProvider {
    ...
    private void offerDustFurnace(RecipeExporter exporter, ItemConvertible dust, ItemConvertible output, String group) {
        offerSmelting(exporter, List.of(dust), RecipeCategory.MISC, output,
                0.7f, 200, group);
        offerBlasting(exporter, List.of(dust), RecipeCategory.MISC, output,
                0.7f, 100, group);
    }

    @Override
    public void generate(RecipeExporter exporter) {
        offerDustFurnace(exporter, ModItems.TIN_DUST, ModItems.TIN_INGOT, "tin");
        offerDustFurnace(exporter, ModItems.MYTHRIL_DUST, ModItems.MYTHRIL_INGOT, "mythril");
        offerDustFurnace(exporter, ModItems.ADAMANTIUM_DUST, ModItems.ADAMANTIUM_INGOT, "adamantium");
